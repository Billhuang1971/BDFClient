...
class Ui_EEGView(object):
    def setupUi(self, Ui_Form):
        ...
        self.glBtn.addWidget(vline3, 0, 21, 1, 1)
        ...
        self.hideWave = QtWidgets.QPushButton(self.gbSample)
        self.hideWave.setObjectName("hideWave")
        self.glSample.addWidget(self.hideWave, 1, 0, 1, 1)
        self.hideState = QtWidgets.QPushButton(self.gbSample)
    ...
    def retranslateUi(self, ManualForm):
        ...
        self.btnRuler.setText(_translate("Ruler switch", "隐藏秒线"))
        ...
        self.hideWave.setText(_translate("hideWave", "隐藏波形"))
        self.hideState.setText(_translate("hideState", "隐藏状态"))
