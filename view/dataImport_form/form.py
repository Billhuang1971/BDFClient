...
class Ui_DataImportForm(object):
    def setupUi(self, DataImportForm):
        ...
        self.addButton = QtWidgets.QPushButton(DataImportForm)
        ...
        self.delButton = QtWidgets.QPushButton(DataImportForm)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        # 刷新按钮
        # self.flushButton = QtWidgets.QPushButton(DataImportForm)
        # sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        # sizePolicy.setHorizontalStretch(0)
        # sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, DataImportForm):
        ...
        # self.flushButton.setText(_translate("DataImportForm", "刷新界面"))
        self.groupBox.setTitle(_translate("DataImportForm", "信息窗口"))
        self.chooseBtn.setText(_translate("DataImportForm", "选择文件"))
        self.processButton.setText(_translate("DataImportForm", "处理文件"))
        self.groupBox_2.setTitle(_translate("DataImportForm", "远程文件"))
        self.sendMsgButton.setText(_translate("DataImportForm", "上传完成"))
