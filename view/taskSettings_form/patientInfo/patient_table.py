...
class PatientTableWidget(QWidget):
    ...
    def init_ui(self, current_page=1, col_label=None, sampleList=None, totalNum=0, on_clicked_selectBtn=None,theme_id=None):
        ...
        for row in range(0, self.tableRow):
            for col in range(0, self.tableCol-1):
                ...
                selectBtn = QPushButton('选择脑电文件')
                selectBtn.clicked.connect(partial(on_clicked_selectBtn, row, self.thme_id))
