...
class Ui_EEGView(object):
    def setupUi(self, Ui_Form):
        ...
        self.glBtn.addWidget(self.btnUping, 0, 7, 1, 2)
        ...
        self.glBtn.addWidget(vline1, 0, 9, 1, 1)
        ...
        self.glBtn.addWidget(self.editTimeText, 0, 10, 1, 1)
        ...
        self.glBtn.addWidget(self.editTime, 0, 11, 1, 1)
        ...
        self.glBtn.addWidget(self.secondsSpanText, 0, 12, 1, 1)
        ...
        self.glBtn.addWidget(self.secondsSpan, 0, 13, 1, 1)
        ...
        self.glBtn.addWidget(self.moveLengthText, 0, 15, 1, 1)
        ...
        self.glBtn.addWidget(self.moveLength, 0, 16, 1, 1)
        ...
        self.glBtn.addWidget(self.sensitivityText, 0, 17, 1, 1)
        ...
        self.glBtn.addWidget(self.sensitivity, 0, 18, 1, 1)

        vline4 = QFrame()
        vline4.setFrameShape(QFrame.VLine)
        vline4.setFrameShadow(QFrame.Sunken)
        self.glBtn.addWidget(vline4, 0, 19, 1, 1)
        ...
        self.glBtn.addWidget(self.subtractAverage, 0, 20, 1, 1)
        ...
        self.glBtn.addWidget(self.secondsLine, 0, 21, 1, 1)

        vline3 = QFrame()
        vline3.setFrameShape(QFrame.VLine)
        vline3.setFrameShadow(QFrame.Sunken)
        self.glBtn.addWidget(vline3, 0, 22, 1, 1)
