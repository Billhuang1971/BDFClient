...
class diagTrainingController(QWidget):
    ...
    def on_clicked_manual_query(self, diags_viewInfo,patient_name):
        ...
        self.page = ['file_name']
        try:
            msg = [self.check_id, self.file_id, self.patient_id,self.content_uid,self.class_id,self.client.tUser[0]]
    ...
    def dl_init_SampleList(self):
        ...
        user_names ="('{}')".format(self.userNamesDict.get(self.content_uid))

        msg = [self.check_id, self.file_id, channels,type_names, user_names, status_show]
        self.client.dl_init_SampleList(msg)
    ...
    def on_btnSetting_clicked(self):
        ...
        user_name = [self.userNamesDict.get(self.content_uid)]
    ...
    def on_btnUping_clicked(self):
        print(f"on_btnUping_clicked: self.check_id={self.check_id},file_id={self.file_id},self.duration={self.duration}")
        if self.duration is None:
            return
